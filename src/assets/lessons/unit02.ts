  ...
  [
    ...
    new Section(
      ...
      [
        ...
        'One commonly suggested point of division is chromosomes, of course that is to say whether someone is XX or XY. Yet, then how do we define people with atypical chromosomes? Are they a third sex, or fourth sex, or fifth sex, and so forth? This is not something that many people would argue. Someone may then say that these are simply mutations or disorders, and that a person with atypical chromosomes are still male or female. By most beliefs, this is the case, but that very assertion itself disqualifies chromosomes as an absolute determinant of sex. (After all, if someone with Klinefelter Syndrome (XXY) is not disqualified from being considered male based on their sex chromosomes, why would it be any different for a transgender person?)',
...
let lesson0204: TextLesson = new TextLesson(
  ...
  [
    new Section(
      ...
      [
        'To return to the issue of the definition of transsexual vs transgender, the term transsexual has likewise fallen out of favor for most, as it is viewed as both essentialist and exclusionary, particularly towards nonbinary identities. In a healthcare setting, consider the implications of a practice that treats transsexuals in how it would relate to nonbinary people seeking the same medical care. This is not even a hypothetical scenario, and even with less sex essentialist terminology many nonbinary people find themselves having to misrepresent who they are in order to achieve care. To make matters even more complicated, transsexual has also been co-opted by hostile political interests and is commonly used as a smokescreen, as people claim they support “authentic transsexuals”. Some trans people will self-apply the label for a similar reason, as indicative of their supposed authenticity opposed to those they view as part of a social trend. In the spirit of this course, it must be stated that these beliefs should never be allowed to inform patient care, including patient interaction in any form, and it is thus also recommended that the phrase transsexual should be explicitly avoided even if it is not technically invalid.'
      ]
...
let lesson0207: VideoLesson = new VideoLesson(
  ...
  '<!--suppress HtmlDeprecatedAttribute --><iframe width="560" height="315" src="https://www.youtube.com/embed/PR4I9XcyCI4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>\n',
  [
      'We now get to the question... what exactly does it mean to be transgender? This isn\'t easy to explain, so let’s break this down further into a few additional questions that will hopefully provide some general concepts.',
      'How does someone recognize they are transgender/nonbinary?\nAre there requirements to being transgender?\nTo be transgender, do you have to transition in some way?What might someone do to transition if they are transgender?',
      ...
      'Now, at this point you may be wondering why this unit didn’t lead with this part of the discussion and chose to discuss contentious or negative topics first. Unfortunately, that was all also part of being transgender. Every transgender and/or nonbinary person is a philosopher to some degree, who has been forced to consider the topic of what it means to be male or female, or neither, whether they want to or not. What was summarized here in a dozen paragraphs may even be part of an internal dialogue lasting decades, and that is just the tip of the iceberg.',
      'The hope is that by providing those topics first, you will go into the following portion of the unit with the recognition that nothing about any of this is simple or ill-considered at any level.',
      'On the topic of understanding how one recognizes they are transgender, it helps to try to get some personal perspective. Presuming you are cisgender, if you were to consider your own gender, can you describe what it feels like? There is no easy answer, if a universal answer is possible at all, and this also applies to transgender people. ',
    'There are countless individual narratives about personal recognition, this may often not come down to an innate sense of what one is, though it certainly can, but rather recognizing that there is something incongruent about one’s current existence in some manner in regards to gender. In other words, it can hinge on what one is not. For some this is discomfort with their physical body. Others may find themselves disturbed by external perceptions in social interactions. When caused by gender incongruency, this is what we mean by Gender Dysphoria, which will be discussed in the following lesson.'
    ]
);
